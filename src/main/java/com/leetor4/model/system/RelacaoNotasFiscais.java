...
public class RelacaoNotasFiscais {
	...
	public Map<Integer, Object[]>  relacaoNotasFiscais(File diretorio, String operacao) throws IOException, JAXBException {
	    ...
	    data.put(indice, 
	    new Object[]
	    {"ID","OPERACAO","CHAVE","UF","COD_NF","NAT_OPERAÇÃO","MODELO_DOC","SERIE","NUM_DOC","DT_EMISSAO","DT_ENTSAI","TIPO_NF","ID_DEST","COD_MUN_FG","TP_IMP","TP_EMI","C_DV","TP_AMB","FIN_EMI","PROC_EMI","VER_PROC",
...
//				      );
		        ...
		        new Object[]{id, operacao,n.getIdent().getChaveeletronica(),
		        		 ...
		        		 (n.getIdent().getDataEntSai()==null?"":UtilsEConverters.getStringParaData(n.getIdent().getDataEntSai().substring(0,10))),
