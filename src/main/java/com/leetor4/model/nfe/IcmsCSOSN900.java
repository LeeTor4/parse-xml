...
public class IcmsCSOSN900 {
	...
	public IcmsCSOSN900(CstIcms cst, String modBC, String vBC, String aliqRedBC, String aliqICMS, String vICMS,
			String modBCST, String aliqMVAST, String aliqRedBCST, String vBCST, String aliqCredSN, String vCredICMSSN) {
		super();
		this.cst = cst;
		this.modBC = modBC;
		this.vBC = vBC;
